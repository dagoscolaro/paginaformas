...
const images = [
    { src: 'img/triangulo.png', sound: 'aud/triangulo.mp3' },
    { src: 'img/circulo.png', sound: 'aud/circulo.mp3' },
    { src: 'img/cuadrado.png', sound: 'aud/cuadrado.mp3' },
    { src: 'img/estrella.png', sound: 'aud/estrella.mp3' },
    { src: 'img/corazon.png', sound: 'aud/corazon.mp3' }
];
...
function drop(event) {
    ...
    if (draggableElement && droppableElement) {
        ...
        if (draggableIndex === droppableIndex) {
            ...
            playDefeatSound();
            showResult('¡Esa forma no va ahí! Inténtalo de nuevo');
        }
    }
}
